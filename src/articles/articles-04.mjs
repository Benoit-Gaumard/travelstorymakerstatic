export default [
{
  slug: 'how-to-book-a-cheap-flight',
  title: 'How to book a cheap flight',
  h1: 'How to book a cheap flight',
  description: 'When to book, which days are genuinely cheaper, why the "clear your cookies" advice is a myth, and the techniques that really cut a fare.',
  photo: 'blog-flights',
  published: '2026-08-26',
  updated: '2026-08-27',
  minutes: 11,
  tags: ['Flights', 'Budget', 'Planning'],
  body: `
...
<h2>2. Book in the right window</h2>
<p>Fares are usually cheapest somewhere in the middle of the booking curve, not at either end. Too early and only the airline's standard fare is loaded; too late and the cheap buckets are gone.</p>
<ul>
<li><strong>Short-haul:</strong> roughly one to three months ahead.</li>
<li><strong>Long-haul:</strong> roughly two to six months ahead.</li>
<li><strong>Peak season, school holidays, Christmas, major events:</strong> earlier, because demand fills the cheap buckets long before the curve would normally bottom out.</li>
</ul>
<p>Last-minute bargains on scheduled flights are largely a myth. They existed when airlines dumped unsold seats; modern revenue management raises prices as departure approaches because the people still buying are business travellers who have no choice.</p>
...
<p>Two related techniques:</p>
<ul>
<li><strong>Positioning flights.</strong> Fly cheaply to a big hub, then take a separate long-haul ticket from there. Common when your local airport has poor long-haul competition.</li>
<li><strong>Open-jaw and multi-city.</strong> Flying into one city and out of another is often the same price as a return, and saves you backtracking. Always price it before assuming a return is cheaper.</li>
</ul>
<p><strong>The critical warning:</strong> two separate tickets are two separate contracts. If the first is delayed and you miss the second, no airline owes you anything. Leave at least four hours between separate tickets on short-haul and a full overnight on long-haul, and never check a bag through on a self-connection unless the airlines have an agreement.</p>
...
<li>The cost of an overnight if the connection forces one.</li>
</ul>

<h2>6. Consider one long stopover instead of a fast connection</h2>
<p>Several national carriers price a long stopover at their hub the same as a short one, and some run free or heavily discounted stopover programmes. It turns a connection you were going to endure into an extra destination, and it is frequently the cheapest routing anyway.</p>

<h2>7. Set alerts and let the search run in the background</h2>
<p>Rather than checking daily, set a price alert on the route and let it tell you. Most flight search engines do this free by email. It removes the temptation to refresh, and it catches the short-lived drops that happen when an airline releases a new fare bucket or launches a sale.</p>
<p>Sales genuinely exist and are usually announced in January and September, when demand is lowest.</p>

<h2>Things that do not work</h2>
<ul>
<li><strong>Clearing cookies or using incognito.</strong> This has been tested repeatedly and does not lower fares. Prices change because inventory changes, not because a site recognises you. Incognito costs nothing, so use it if it makes you feel better, but do not expect a discount.</li>
<li><strong>Using a VPN to appear in a poorer country.</strong> Point-of-sale pricing exists, but the currency, payment card and residency checks usually undo it, and some airlines cancel tickets bought this way.</li>
<li><strong>Waiting for a last-minute crash.</strong> See above.</li>
<li><strong>Booking on a specific day of the week.</strong> Obsolete.</li>
</ul>
...
<ol>
<li>Search a whole month, not a date, and note the three cheapest days.</li>
<li>Widen the search to nearby airports at both ends.</li>
<li>Set a price alert and wait, rather than watching.</li>
<li>When a fare appears that is clearly below the running average, book it. Do not try to time the exact bottom.</li>
<li>Before paying, add baggage and transfers and compare the true total against one full-service option.</li>
</ol>
...
{
  slug: 'how-to-rent-a-car-while-traveling',
  title: 'How to rent a car while travelling',
  h1: 'How to rent a car while travelling',
  description: 'The excess trap, why the fuel policy matters more than the daily rate, what an International Driving Permit is, and how to avoid a damage dispute.',
  photo: 'blog-car-rental',
...
<h2>Fuel policy: only one is acceptable</h2>
<p><strong>Full to full</strong> is the only policy that does not cost you money. You collect the car full and return it full, paying only for what you used.</p>
<p>Avoid <strong>full to empty</strong> (sometimes marketed as "pre-purchase fuel"): you buy a tank at the company's price, which is above the pump price, and you get nothing back for what you do not use. Returning a car with a third of a tank left is a straightforward donation.</p>
...
<li><strong>Cross-border rules.</strong> Many contracts forbid taking the car into a neighbouring country, or require a declared permission and a fee. Ferries are usually forbidden outright.</li>
<li><strong>Transmission.</strong> Manual is the default in much of Europe, automatic in North America. If you can only drive one, book it explicitly.</li>
<li><strong>Winter equipment.</strong> Snow tyres or chains are legally required in some countries in winter, and are almost always an extra.</li>
<li><strong>Deposit method.</strong> Most companies require a credit card in the main driver's name. Debit cards are frequently refused, and this strands people at the counter more than any other single issue.</li>
</ul>
...
<li><strong>Check the tyres</strong>, including the spare.</li>
</ol>
...
<ul>
<li><strong>Which side of the road.</strong> About 35% of the world's population drives on the left, mostly former British territories. In Europe: the UK, Ireland, Malta and Cyprus.</li>
<li><strong>Urban restricted zones.</strong> Italy's ZTL cameras issue fines by post months later; low-emission zones in several European cities need pre-registration.</li>
...
<p>A car is a liability in dense historic cities: parking is expensive or impossible, restricted zones are enforced by camera, and public transport is usually better. The efficient pattern is to see the cities on foot and by train, then rent for the days you need the countryside, and return it before the next city.</p>
<p>Renting for two weeks and leaving it parked for eight days is the most common and most expensive mistake in the whole exercise.</p>

<div class="callout"><p><strong>Related reading:</strong> <a href="/guides/desert-travel/">what the desert asks of you</a> covers driving in soft sand and remote-area preparation, and <a href="/guides/island-hopping/">island hopping</a> explains why vehicle ferry space needs booking.</p></div>
`,
},
{
  slug: 'where-to-stay-while-traveling',
  title: 'Where to stay while travelling',
  h1: 'Where to stay while travelling',
  description: 'Hotels, guesthouses, hostels and apartments compared honestly: what each is good at, how to pick a neighbourhood, and the costly booking mistakes.',
  photo: 'blog-stay',
...
<h3>Hotels</h3>
<p><strong>Good at:</strong> predictability, a 24-hour desk, luggage storage before check-in and after check-out, and someone accountable when something breaks. Breakfast included is often better value than it looks once you price the alternative.</p>
<p><strong>Weak at:</strong> cost per person for families or groups, and any sense of the place you are in.</p>
<p><strong>Best for:</strong> short city stays, late arrivals, business trips, and anywhere you need certainty.</p>

<h3>Guesthouses, B&Bs and pensions</h3>
<p><strong>Good at:</strong> the single best ratio of price to local knowledge. A family-run guesthouse gives you a host who will tell you where to eat, which bus to take, and what is happening this weekend. The money also stays in the local economy far more than it does at a chain.</p>
<p><strong>Weak at:</strong> flexible hours, and occasionally at plumbing.</p>
...
<h3>Apartments and short-term rentals</h3>
<p><strong>Good at:</strong> space, a kitchen, laundry, and cost for groups or stays over four or five nights. Being able to cook one meal a day changes the budget of a long trip substantially.</p>
<p><strong>Weak at:</strong> arrival logistics (key handover at a specific hour, nobody to call at midnight), cleaning fees on short stays, and the fact that in many cities they have removed long-term housing from residents. Barcelona, Lisbon, Amsterdam and Kyoto have all legislated in response.</p>
...
<p>Three checks:</p>
<ol>
<li><strong>Open a map and find the places you actually want to go.</strong> Draw a rough circle around them. Book inside it.</li>
<li><strong>Check the walk to the nearest metro, tram or bus stop</strong>, and whether that line runs when your flight lands.</li>
<li><strong>Look at the street on a map's photo view.</strong> Thirty seconds tells you whether it is a residential street or a six-lane road.</li>
</ol>
<p>A useful rule for unfamiliar cities: pick somewhere within a fifteen-minute walk of a market. Markets are where people live, which means food, transport and a functioning neighbourhood.</p>

<h2>Reading reviews properly</h2>
<p>Ignore the average score and read the specifics.</p>
<ul>
...
<h2>Booking: direct or through a platform?</h2>
<p>Platforms are excellent for searching and comparing. They are less good for you once something goes wrong, and they take a substantial commission from small properties.</p>
<p>A practical compromise many travellers use: find the place on a platform, then check the property's own website or email them. Independent hotels and guesthouses frequently match or beat the platform price, because they keep the commission, and you get a direct line to a human if your flight is delayed.</p>
<p>Whichever you use, prefer <strong>free cancellation</strong> unless the non-refundable saving is large. Plans change more than you expect on a long trip, and the flexibility is usually worth more than the discount.</p>

<h2>How far ahead to book</h2>
<ul>
<li><strong>First two nights of any trip:</strong> always book. Arriving tired in an unfamiliar place with nowhere to go is the one avoidable misery.</li>
<li><strong>After that:</strong> in low or shoulder season, book two or three days ahead as you go. You will end up staying longer somewhere you had not heard of.</li>
<li><strong>High season, festivals, small islands, popular hiking routes:</strong> book everything. Mountain huts and island rooms sell out months ahead and there is no alternative within thirty kilometres.</li>
</ul>

<h2>Small things that make a real difference</h2>
<ul>
<li><strong>Ask for a room away from the lift, the bar and the road.</strong> It is free and it works about half the time.</li>
<li><strong>Check what time check-in and check-out actually are</strong>, and whether luggage storage is available either side. Losing the first and last day to carrying a bag is a genuine cost.</li>
<li><strong>Confirm arrival time if you land late.</strong> Small guesthouses lock the door at ten.</li>
<li><strong>Screenshot the address in the local language and alphabet.</strong> Taxi drivers do not read your booking app.</li>
<li><strong>Take the business card from reception</strong> on your way out for the first time.</li>
<li><strong>Ask the host one specific question:</strong> "Where do you eat lunch on a work day?" It is worth more than any list of recommendations.</li>
</ul>

<h2>The choice that matters most</h2>
<p>Fewer places, more nights. Every move costs the best part of a day once you count checking out, transport, and finding the next bed. Three nights per stop is the minimum where a place stops being a transaction and starts being somewhere you know.</p>
<p>And every good trip has one place where you stayed a night too few. The fix is a rule: if you find yourself saying "maybe we should stay longer" on the first evening, book the extra night then.</p>

<div class="callout"><p><strong>Related reading:</strong> <a href="/guides/first-solo-trip/">your first solo trip</a> covers booking only the first two nights, and <a href="/guides/responsible-travel/">going somewhere without making it worse</a> looks at where your accommodation money actually lands.</p></div>
`,
},
{
  ...
  updated: '2026-08-27',
  minutes: 9,
  tags: ['Phones', 'eSIM', 'Practical'],
  body: `
<p>Your phone is now the map, the ticket, the translator, the boarding pass and the way you pay for the bus. It is also the single easiest way to come home to a bill larger than the flight.</p>
<p>There are three ways to get connected abroad, and the right answer depends almost entirely on how long you are going and where.</p>
...
<h2>Option 2: a local SIM bought on arrival</h2>
<p><strong>Good at:</strong> price and coverage. A local prepaid SIM is almost always the cheapest data available and gives you a local number, which matters for taxis, deliveries, restaurant bookings and anything that sends a confirmation code.</p>
<p><strong>Weak at:</strong> the first hour. You need to find a shop, sometimes register with a passport, and in some countries wait for activation. Airport kiosks charge a premium; a phone shop in town is usually half the price.</p>
<p><strong>Best for:</strong> stays of a month or more, and any country where you need a local number to function.</p>
...
<p>Almost every horror story comes from the same three causes: an app updating in the background, a video autoplaying, or a phone silently roaming on a network you did not choose.</p>
<p>Before you fly:</p>
<ul>
<li><strong>Turn off data roaming</strong> in your phone's settings, and only turn it back on deliberately once you know which network and plan you are on.</li>
...
<h2>Download everything before you go</h2>
<p>The most useful travel tech habit costs nothing and works with no signal at all.</p>
<ul>
...
<h2>Wifi, and being sensible about it</h2>
...
<h2>Calls, and the SMS problem nobody plans for</h2>
<p>Data-only eSIMs mean calls happen over the internet, which is fine for most people. The failure mode is different: <strong>SMS verification codes</strong>. Banks, airlines and government services still send one-time codes to your home number, and if your home SIM is out of the phone or roaming is off, you will not receive them.</p>
<p>This strands travellers regularly. Two fixes: keep the home SIM installed and active for SMS while using an eSIM for data, or move your accounts to an authenticator app before you travel.</p>

<h2>The physical side</h2>
<ul>
<li><strong>A power bank</strong> of at least 10,000 mAh. Note that airlines require lithium batteries in cabin baggage, never in the hold, and there are capacity limits.</li>
<li><strong>A multi-port charger and one universal adapter</strong>, so a single socket charges everything.</li>
<li><strong>A short cable for the plane and the bus.</strong></li>
<li><strong>Cold and heat kill batteries.</strong> At minus twenty a phone can shut down at 40%; keep it in an inside pocket.</li>
<li><strong>A cheap case and a screen protector</strong> cost less than any repair abroad.</li>
</ul>

<h2>A five-minute pre-flight routine</h2>
<ol>
<li>Turn off data roaming.</li>
...
<div class="callout"><p><strong>Related reading:</strong> the <a href="/destinations/world/">Around the World</a> collection covers why cabin air is drier than most deserts and why aircraft windows have a small hole in them.</p></div>
`,
},
];
