export default [
{
  ...
  description: 'Foreign transaction fees, the dynamic currency conversion trap, why you carry two cards on different networks, and what matters when choosing.',
  photo: 'blog-money',
...
},
{
  ...
  description: 'Forty practical habits collected from the road: before you go, at the airport, on arrival, and the ones you only learn by being caught out.',
  photo: 'blog-tips',
