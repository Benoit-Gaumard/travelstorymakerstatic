export default [
{
  slug: 'which-credit-card-to-use-abroad',
  title: 'Which credit card to use abroad',
  h1: 'Which credit card to use abroad',
  description: 'Foreign transaction fees, the dynamic currency conversion trap, why you should always carry two cards on different networks, and what actually matters when choosing one.',
  photo: 'blog-money',
  published: '2026-08-22',
  updated: '2026-08-27',
  minutes: 9,
  tags: ['Money', 'Cards', 'Practical'],
  body: `
<p class="prose__meta">General information for travellers, not financial advice. Card terms differ by country and by issuer, and they change. Always read the terms of the specific product before relying on it.</p>

<p>Paying abroad is one of the few areas of travel where a small amount of preparation reliably saves a measurable amount of money. Not through a clever trick, but by avoiding three specific charges that most travellers pay without noticing.</p>
...
<h3>3. Cash machine charges</h3>
<p>Two separate charges can apply: your own bank's withdrawal fee, and the machine operator's fee. The second is disclosed on screen before you confirm and can be surprisingly large in tourist areas.</p>
<p>Practical rules: withdraw larger amounts less often, use machines attached to real banks rather than the standalone ones in shops and airports, and decline the conversion offer.</p>

<h2>What actually matters when choosing a card</h2>
<ol>
...
<h2>Credit or debit?</h2>
<p>Use both, for different things.</p>
<p><strong>Credit</strong> for anything expensive or delivered in the future: flights, hotels, tours, car rental. You get chargeback rights, and a fraudulent charge is the bank's money until it is resolved rather than yours.</p>
<p><strong>Debit</strong> for cash withdrawals and small day-to-day spending, ideally on an account holding only what you need for the trip, so a compromise is contained.</p>
...
<li>Break large notes early. Nobody at a market has change for the biggest note in circulation.</li>
</ul>
...
<p>Phone payment works essentially everywhere contactless cards do, and it has two genuine advantages abroad: the card number is never exposed to the merchant, and you can carry the physical cards separately. It is not a replacement for them, because a flat battery is a real thing and some terminals and cash machines still need the plastic.</p>

<h2>The short version</h2>
<ol>
<li>Get one card with no foreign transaction fee before your next trip.</li>
<li>Always pay in the local currency. Always.</li>
<li>Carry two cards on different networks, kept in different places.</li>
<li>Use credit for big and future purchases, debit for cash.</li>
<li>Withdraw larger amounts, less often, from bank machines.</li>
<li>Carry some cash, and never change money at the airport.</li>
</ol>

<div class="callout"><p><strong>Related reading:</strong> <a href="/guides/how-to-rent-a-car-while-traveling/">how to rent a car while travelling</a> explains why the credit card requirement matters, and <a href="/guides/which-travel-insurance-to-choose/">which travel insurance to choose</a> covers what card-included cover usually leaves out.</p></div>
`,
},
{
  slug: 'which-travel-insurance-to-choose',
  title: 'Which travel insurance to choose',
  h1: 'Which travel insurance to choose',
  description: 'What travel insurance is actually for, the exclusions that catch people out, single-trip versus annual, and how to work out the cover level you need.',
  photo: 'blog-insurance',
  published: '2026-08-21',
  updated: '2026-08-27',
  minutes: 10,
  tags: ['Insurance', 'Health', 'Planning'],
  body: `
<p class="prose__meta">General information for travellers, not insurance or medical advice. Policies, legal requirements and health entitlements differ by country of residence and destination. Read the policy wording of any product before buying it.</p>

<p>Most people buy travel insurance for lost luggage and cancelled flights. Those are the smallest part of what it does. The reason it exists is a single scenario: you are seriously injured or ill in a country whose healthcare you have to pay for, and you need to be treated, stabilised and flown home.</p>
<p>That is a bill that can run into six figures. Everything else in the policy is secondary.</p>
...
<p>Claims are refused far more often for these than for anything else. Read this list against your actual plans.</p>
<ul>
<li><strong>Undeclared pre-existing medical conditions.</strong> The single biggest cause of refused claims. Declare everything, even things you consider resolved. A higher premium is cheaper than an unpaid hospital bill.</li>
...
<p>One trap worth naming: most annual policies require you to <strong>start your journey from your home country</strong>. If you are already abroad when you buy, many insurers will not cover you at all, and the ones that will charge more.</p>

<h2>Card-included insurance: check before relying on it</h2>
<p>Premium credit cards frequently include travel cover, and it can be genuinely good. It also commonly requires that you paid for the trip with that card, caps trip length at 30 or 60 days, excludes travellers over a certain age, and has lower medical limits than a standalone policy.</p>
...
<ul>
<li><strong>Call the emergency line before treatment</strong> where you can. Many policies require pre-authorisation for anything non-trivial, and the assistance company will often pay the hospital directly.</li>
<li><strong>Keep every receipt, report and discharge document.</strong> Photograph them immediately.</li>
<li><strong>Get a police report within 24 hours</strong> for theft or loss, and a written report from the airline for baggage.</li>
<li><strong>Do not agree to be discharged or moved</strong> without telling the assistance company.</li>
</ul>
...
{
  slug: 'tips-and-tricks-for-traveling',
  title: 'Tips and tricks for travelling',
  h1: 'Tips and tricks for travelling',
  description: 'Forty practical habits collected from the road — before you go, at the airport, on arrival, on the ground, and the ones that only make sense once you have been caught out.',
  photo: 'blog-tips',
  published: '2026-08-20',
  updated: '2026-08-27',
  minutes: 11,
  tags: ['Practical', 'Planning', 'Habits'],
  body: `
<p>None of these are clever. They are the habits that experienced travellers do automatically, mostly because at some point they did not, and it cost them a day.</p>

<h2>Before you go</h2>
<ul>
<li><strong>Photograph your passport, visas, insurance and tickets</strong>, and email them to yourself. A link is useless without data; a file is not.</li>
<li><strong>Check your passport expiry against the six-month rule.</strong> Many countries refuse entry if your passport expires within six months of arrival, and airlines enforce it at check-in.</li>
<li><strong>Check the visa requirement for your nationality</strong>, not for the country you live in. They are not always the same.</li>
<li><strong>Check whether you need proof of onward travel.</strong> Airlines are fined for carrying passengers who are refused entry, so they check even when the country would not have.</li>
<li><strong>Buy insurance the day you book</strong>, not the week you fly. Cancellation cover starts when the policy does.</li>
<li><strong>Tell one person at home your rough plan</strong>, and agree a check-in schedule you will actually keep.</li>
<li><strong>Learn ten words:</strong> hello, please, thank you, sorry, yes, no, how much, where is, delicious, goodbye. They change every interaction of the trip.</li>
<li><strong>Move your accounts to an authenticator app</strong> so bank codes do not depend on an SMS reaching your home number.</li>
<li><strong>Check the plug type and voltage.</strong> One universal adapter with USB built in solves it.</li>
<li><strong>Find out what the local holidays are.</strong> Arriving during a week when everything is closed is avoidable.</li>
</ul>
...
<li><strong>Laundry soap sheets</strong> weigh nothing and replace three shirts.</li>
<li><strong>Medication in original packaging</strong>, with a copy of the prescription. Some common drugs are controlled substances elsewhere.</li>
<li><strong>Lithium batteries and power banks go in the cabin</strong>, never the hold. This is a legal requirement, not a preference.</li>
<li><strong>A packable day bag</strong> that folds into its own pocket, so your main bag stays in the room.</li>
<li><strong>Earplugs and an eye mask.</strong> The cheapest sleep insurance there is.</li>
</ul>

<h2>At the airport and on the plane</h2>
<ul>
<li><strong>Take a photo of the departure board</strong> if your flight is delayed. You will need it to claim.</li>
<li><strong>Bring an empty bottle through security</strong> and fill it airside.</li>
<li><strong>Window seat to sleep, aisle to move.</strong> Decide before you check in; it is worth more than any seat hack.</li>
...
<h2>On arrival</h2>
<ul>
<li><strong>Arrive in a new city in daylight</strong> where you can. Most unpleasant arrival stories start with a night bus into an unfamiliar station.</li>
<li><strong>Get outside for twenty minutes.</strong> Daylight does more for jet lag than anything you can buy.</li>
<li><strong>Take a business card from reception</strong> before you leave the first time.</li>
<li><strong>Screenshot your address in the local language and alphabet.</strong> Taxi drivers do not read your booking app.</li>
<li><strong>Withdraw cash from a machine attached to a real bank</strong>, and always decline the offer to be charged in your home currency. That offer is a fee.</li>
<li><strong>Break large notes early.</strong> Nobody at a market has change for the biggest note in circulation.</li>
<li><strong>Give the first day nothing important.</strong> A walk, a market, a simple meal, an early night.</li>
</ul>

<h2>On the ground</h2>
<ul>
<li><strong>Pick the stall with the longest queue of people not holding cameras.</strong> It has never once failed.</li>
<li><strong>Eat at the local hour, not yours.</strong> A restaurant serving dinner three hours early is serving tourists.</li>
<li><strong>Ask "where do you eat lunch on a work day?"</strong> rather than "where's a good restaurant?"</li>
<li><strong>Sit on the same bench for an hour.</strong> A neighbourhood reveals its whole schedule: school, deliveries, lunch, dogs, old men, children again.</li>
<li><strong>Walk ninety minutes in one direction, then turn around.</strong> You will find more than any list of top ten sights.</li>
<li><strong>Watch what everyone else does for ten minutes</strong> before worrying about etiquette. Copying works better than research.</li>
<li><strong>Say yes to the invitation.</strong> The best days of most trips were not planned by the person having them.</li>
<li><strong>Book the extra night on the first evening</strong> if you catch yourself saying "maybe we should stay longer".</li>
<li><strong>Keep one card and some cash somewhere separate</strong> from everything else.</li>
<li><strong>Edit your photos each evening.</strong> Ten minutes deleting near-duplicates leaves a set you will actually look at again.</li>
</ul>
...
<li>Keep receipts until the rental deposit clears, which can take a month.</li>
</ul>

<h2>The ones that only make sense once you have been caught out</h2>
<ul>
<li><strong>Return a hire car during staffed hours</strong> and get a signed sheet. An out-of-hours key drop puts the whole burden of proof on you.</li>
<li><strong>Film the hire car before you leave the bay</strong>, and again at drop-off.</li>
<li><strong>Check the last boat, bus or train time on the day you leave</strong>, then check it again at the station.</li>
<li><strong>Leave a spare day before any flight home</strong> if boats or mountain roads are involved.</li>
<li><strong>Do not put anything in a bag you cannot see</strong> on a long-distance bus at night.</li>
<li><strong>Trust the physical signal your body gives you</strong> in a situation. It is usually right, and it is always cheaper to act on than to override.</li>
</ul>
...
<p>That is not a failure of documentation. That is the trip.</p>

<div class="callout"><p><strong>Related reading:</strong> the full <a href="/guides/">guides section</a> goes deeper on packing, altitude, jet lag and seasons, and the <a href="/travelstories/stories/">travel stories</a> collection is where most of these habits were learned the hard way.</p></div>
`,
},
];
